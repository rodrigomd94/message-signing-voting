...
const Home: NextPage = () => {
  ...
  return (
    <div className="px-10">
      <Head>
        <title>Message signing voting dApp</title>
      ...
      <div className="mx-40 my-10">
        <Link href="/polls">
          <button className="btn btn-primary m-5" >See all Polls</button>
        </Link>
        <Link href="/createPoll">
          <button className="btn btn-primary m-5" >Create a poll</button>
        </Link>
      </div>
    </div>
  )
